...
describe("Wave 7 — no Circuit Breaker loses", () => {
  it("Wave 6 topology without Circuit Breaker fails when chaos hits", () => {
    ...
    // Post Data Cache redesign: Servers fan in to a shared Data Cache, then DB.
    ...
    wire(state, { component: gateway.component, egressPortId: gateway.egressPortId }, { component: lb.component, ingressPortId: lb.ingressPortId }, "c-gw-lb", { bandwidth: 600 });
    ...
    wire(state, { component: server1.component, egressPortId: server1.egressPortId }, { component: dataCache.component, ingressPortId: dataCache.ingressPortId }, "c-s1-dc", { bandwidth: 600 });
    wire(state, { component: server2.component, egressPortId: server2.egressPortId }, { component: dataCache.component, ingressPortId: dataCache.ingressPortId }, "c-s2-dc", { bandwidth: 600 });
