...
- **Mid-wave chaos event execution.** `getScheduledChaos` is typed and called — but I haven't verified the engine reacts (degrades component condition, severs a connection, etc.). Wave 7 first-brainstorm question.
