...
export const CAMPAIGN_WAVES: ReadonlyArray<CampaignWave> = [
  ...
  },
  {
    ...
    briefing: "~140 req/sec with 55% marketing images and 20% sign-in traffic. Large payloads and auth handshakes would crush your Servers at this scale. Put a CDN at the edge to absorb the image flood and an API Gateway to terminate auth before traffic ever reaches the read path.",
    ...
    wave: {
      ...
      packetRate: 10,
      duration: 12,
      composition: { writeRatio: 0.15, authRatio: 0.2, streamRatio: 0, largeRatio: 0.55, asyncRatio: 0 },
