...
/**
 * Auth gate for the campaign-level-select page.
 *
 * Mirrors levels-boot.ts — the landing page is the sign-in surface; if the
 * user reaches campaign.html with auth configured but no session, bounce
 * them home. Local dev without Supabase skips the gate.
 */
