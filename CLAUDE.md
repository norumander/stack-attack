...
**Current stage:** Phase 1, Stage 3e augmented. TD mode is playable through Wave 7. Waves 6+7 teach async workloads (Queue/Worker) and chaos resolution (CircuitBreaker). 697 tests, typecheck clean.
