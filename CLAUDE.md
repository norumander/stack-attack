...
**Current stage:** Phase 1, Stage 4b complete. TD mode is playable through Wave 9. Wave 9 teaches geographic latency (multi-zone + DNS/GTM routing). 724 tests, typecheck clean.
