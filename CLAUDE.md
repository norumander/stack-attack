...
**Current stage:** Phase 1, Stage 4a complete. TD mode is playable through Wave 8. Wave 8 teaches streaming traffic isolation (Streaming Server + Blob Storage). 708 tests, typecheck clean.
